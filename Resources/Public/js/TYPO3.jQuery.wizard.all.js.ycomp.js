...
function jsGraphics(a, b) {
    ...
    this.fillArc = function(e, G, B, i, f, u) {
        var F = B >> 1,
            ...
            z = (v >> 1) * (1 - (E << 1)) + r,
            c = (r >> 1) - v * ((E << 1) - 1),
            A, n, l, D, C = (1 << (Math.floor((f %= 360) / 180) << 3)) | (2 << (Math.floor((u %= 360) / 180) << 3)) | ((f >= u) << 16),
            h = new Array(E + 1),
            w = new Array(E + 1);
        f *= Math.PI / 180;
        u *= Math.PI / 180;
...
var canvasClass = Class.extend({
    ...
    init: function(c, a, b) {
        ...
        this.imageOrigW = parseInt(TYPO3.jQuery(this.pictureId + " > #image > img").attr("width"));
        this.imageOrigH = parseInt(TYPO3.jQuery(this.pictureId + " > #image > img").attr("height"));
        this.formBlueprints = this.parseFormToBluePrint(this.formsId);
        TYPO3.jQuery(this.formsId).empty();
        this.setScale(1)
    },
    ...
    setScale: function(b) {
        ...
        TYPO3.jQuery(this.pictureId + " > #image > img").width(this.getMaxW());
        TYPO3.jQuery(this.pictureId + " > #image > img").height(this.getMaxH());
        TYPO3.jQuery(this.pictureId).width(this.getMaxW());
        TYPO3.jQuery(this.pictureId).height(this.getMaxH());
        var a = this;
        TYPO3.jQuery.each(this.areaObjectList, function(d, c) {
            a.areaObjects[c].setScale(a.scaleFactor);
            a.updateCanvas(c)
        });
        TYPO3.jQuery(this.canvasId).width(this.getMaxW()).height(this.getMaxH())
    },
    mousedown: function(c) {
        var a = c.pageX - TYPO3.jQuery(this.canvasId).offset().left;
        var d = c.pageY - TYPO3.jQuery(this.canvasId).offset().top;
        this.mouseIsDown = true;
        var b = this;
        TYPO3.jQuery.each(TYPO3.jQuery(this.formsId + " > div"), function(f, g) {
            if ((b.mouseCurrentObjectDrag == -1) && (b.mouseCurrentEdgeDrag == -1)) {
                var e = b.areaObjects[TYPO3.jQuery(this).attr("id")].hitOnObjectEdge(a, d, 3);
                if (e != -1) {
                    b.areaObjects[TYPO3.jQuery(this).attr("id")].pushUndoableAction();
                    b.mouseCurrentObjectDrag = TYPO3.jQuery(this).attr("id");
                    b.mouseCurrentEdgeDrag = e;
                    c.stopPropagation()
                }
            }
            if ((b.mouseCurrentObjectDrag == -1) && (b.mouseCurrentBorderDrag == -1)) {
                var e = b.areaObjects[TYPO3.jQuery(this).attr("id")].hitOnObjectBorder(a, d, 5);
                if (e != -1) {
                    b.areaObjects[TYPO3.jQuery(this).attr("id")].pushUndoableAction();
                    b.mouseCurrentObjectDrag = TYPO3.jQuery(this).attr("id");
    ...
    mousemove: function(b) {
        var a = b.pageX - TYPO3.jQuery(this.canvasId).offset().left;
        var c = b.pageY - TYPO3.jQuery(this.canvasId).offset().top;
    ...
    dblclick: function(c) {
        ...
        TYPO3.jQuery.each(TYPO3.jQuery(this.formsId + " > div"), function(f, g) {
            var e = b.areaObjects[TYPO3.jQuery(this).attr("id")].hitOnObjectEdge(a, d, 3);
            if (e != -1) {
                if (b.areaObjects[TYPO3.jQuery(this).attr("id")].edgeWasHit(e)) {
                    b.updateCanvas(TYPO3.jQuery(this).attr("id"));
                    b.updateForm(TYPO3.jQuery(this).attr("id"))
                }
            }
            var e = b.areaObjects[TYPO3.jQuery(this).attr("id")].hitOnObjectBorder(a, d, 5);
            if (e != -1) {
                if (b.areaObjects[TYPO3.jQuery(this).attr("id")].borderWasHit(e, a, d)) {
                    b.updateCanvas(TYPO3.jQuery(this).attr("id"));
                    b.updateForm(TYPO3.jQuery(this).attr("id"))
                }
            }
    ...
    addArea: function(g, f, c, e, d, b, a) {
        ...
        if (b) {
            TYPO3.jQuery(this.formsId).prepend(g.formMarkup().replace(/OBJID/g, g.getId()))
        } else {
            TYPO3.jQuery(this.formsId).append(g.formMarkup().replace(/OBJID/g, g.getId()))
        }
        TYPO3.jQuery(this.formsId).data("parent", this).sortable({
            distance: 3,
            start: function(h) {
                TYPO3.jQuery("#" + TYPO3.jQuery(h.target).attr("id") + " > .sortbtn").css("visibility", "hidden");
                TYPO3.jQuery("#" + TYPO3.jQuery(h.target).attr("id") + " > div > .sortbtn").css("visibility", "hidden")
            },
            stop: function(h) {
                TYPO3.jQuery(this).data("parent").updateCanvasLayerOrder();
                TYPO3.jQuery(this).data("parent").fixSortbtnVisibility()
            }
        });
    ...
    areaUp: function(c) {
        var b = -1;
        var a = -1;
        TYPO3.jQuery.each(TYPO3.jQuery(this.formsId + " > div"), function(d, e) {
            if (TYPO3.jQuery(e).attr("id") == c) {
                a = TYPO3.jQuery(e).attr("id")
            }
            if (a == -1) {
                b = TYPO3.jQuery(e).attr("id")
            }
        });
        if (b != -1) {
            TYPO3.jQuery("#" + a).insertBefore("#" + b);
            this.updateCanvasLayerOrder()
        }
        this.fixSortbtnVisibility()
    },
    ...
    fixSortbtnVisibility: function() {
        TYPO3.jQuery(this.formsId + " > div > .basicOptions > .sortbtn").css("visibility", "visible");
        TYPO3.jQuery(this.formsId + " > div:first > .basicOptions > .upbtn").css("visibility", "hidden");
        TYPO3.jQuery(this.formsId + " > div:last > .basicOptions > .downbtn").css("visibility", "hidden")
    },
    persistanceXML: function() {
        ...
        var c = this;
        TYPO3.jQuery.each(TYPO3.jQuery(this.formsId + " > div"), function(d, e) {
            if (typeof c.areaObjects[TYPO3.jQuery(e).attr("id")] != "undefined") {
                c.areaObjects[TYPO3.jQuery(e).attr("id")].updateStatesFromForm();
                a = a + "\n" + c.areaObjects[TYPO3.jQuery(e).attr("id")].persistanceXML()
            }
        });
        return a
    },
    addCanvasLayer: function(a) {
        TYPO3.jQuery(this.canvasId).append('<div id="' + a + '_canvas" class="canvas"><!-- --></div>');
    ...
    removeCanvasLayer: function(a) {
        this.canvasVectors[a].clear();
        TYPO3.jQuery("#" + a + "_canvas").remove()
    },
    updateCanvasLayerOrder: function() {
        var b = 100;
        var a = this;
        TYPO3.jQuery.each(TYPO3.jQuery(this.formsId + " > div"), function(c, d) {
            if (typeof a.areaObjects[TYPO3.jQuery(d).attr("id")] != "undefined") {
                TYPO3.jQuery("#" + TYPO3.jQuery(d).attr("id") + "_canvas").css("z-index", b--)
            }
        })
    },
    updateForm: function(b) {
        var a = this.areaObjects[b].formUpdate();
        TYPO3.jQuery.each(a.split('";'), function(d, e) {
            var c = e.split('="');
            if (c[0]) {
                TYPO3.jQuery("#" + c[0]).attr("value", c[1])
            }
        })
    },
    refreshForm: function(a) {
        this.areaObjects[a].updateStatesFromForm();
        TYPO3.jQuery("#" + this.areaObjects[a].getFormId()).replaceWith(this.areaObjects[a].formMarkup().replace(/OBJID/g, a));
        this.areaObjects[a].applyBasicAreaActions(TYPO3.jQuery("#" + a));
    ...
    parseFormToBluePrint: function(b) {
        var a = new Array();
        TYPO3.jQuery(b + " > div").each(function(c) {
            if (TYPO3.jQuery(this).attr("class") == "noIdWrap") {
                a[this.id] = TYPO3.jQuery("#" + this.id).html()
            } else {
                a[this.id] = '<div class="' + this.id + " " + TYPO3.jQuery(this).attr("class") + '" id="MAPFORMID">' + TYPO3.jQuery("#" + this.id).html() + "</div>"
            }
        });
        return a
    },
...
var previewCanvasClass = Class.extend({
    ...
    updateCanvas: function() {
        ...
        var a = this;
        TYPO3.jQuery.each(this.areaObjectList, function(c, b) {
    ...
    getMaxW: function() {
        return TYPO3.jQuery(this.canvasId).width()
    },
    getMaxH: function() {
        return TYPO3.jQuery(this.canvasId).height()
    }
});
var areaClass = Class.extend({
    ...
    remove: function() {
        TYPO3.jQuery("#" + this.getFormId()).remove();
    ...
    updateColor: function(b, a) {
        this.setColor(b);
        TYPO3.jQuery("#" + this.getFormId() + "_main > .colorPreview > div").css("backgroundColor", b);
        TYPO3.jQuery("#" + this.getFormId() + "_color > .colorBox > div").css("backgroundColor", b);
        if (a == 1) {
    ...
    applyBasicAreaActions: function() {
        ...
        TYPO3.jQuery("#" + this.getFormId() + "_upd").data("area", this).click(function(b) {
            var a = TYPO3.jQuery(this).data("area");
            a.pushUndoableAction();
            a.updateCoordsFromForm()
        });
        TYPO3.jQuery("#" + this.getFormId() + "_del").data("area", this).click(function(a) {
            TYPO3.jQuery(this).data("area").remove()
        });
        TYPO3.jQuery("#" + this.getFormId() + " > .basicOptions > .exp > .expUpDown").parent().data("obj", this).data("rel", "#" + this.getFormId() + " > .moreOptions").click(function(a) {
            a.stopPropagation();
            if (!TYPO3.jQuery(this).data("obj").isMoreOptionsVisible()) {
                TYPO3.jQuery(this).data("obj").applyAdditionalAreaActions();
                TYPO3.jQuery(TYPO3.jQuery(this).data("rel")).slideDown("fast")
            } else {
                TYPO3.jQuery(TYPO3.jQuery(this).data("rel")).slideUp("fast")
            }
            TYPO3.jQuery(this).data("obj").toogleMoreOptionsFlag()
        });
        TYPO3.jQuery("#" + this.getFormId() + " > .basicOptions > .colorPreview > div").data("target", this).click(function(b) {
            var a = TYPO3.jQuery(this).data("target");
            var c = TYPO3.jQuery("#" + a.getFormId() + " > .basicOptions > .exp > .expUpDown:visible").parent();
            TYPO3.jQuery(c).trigger("click")
        });
        TYPO3.jQuery("#" + this.getFormId() + "_link").data("obj", this).change(function(b) {
            TYPO3.jQuery(this).data("obj").updateStatesFromForm();
            var a = TYPO3.jQuery(this).data("obj");
            a.pushUndoableAction()
        });
        TYPO3.jQuery("#" + this.getFormId() + "_label").data("obj", this).change(function(b) {
            TYPO3.jQuery(this).data("obj").updateStatesFromForm();
            var a = TYPO3.jQuery(this).data("obj");
            a.pushUndoableAction()
        });
        TYPO3.jQuery("#" + this.getFormId() + "_up").data("obj", this).click(function(a) {
            TYPO3.jQuery(this).data("obj").getCanvas().areaUp(TYPO3.jQuery(this).data("obj").getId())
        });
        TYPO3.jQuery("#" + this.getFormId() + "_down").data("obj", this).click(function(a) {
            TYPO3.jQuery(this).data("obj").getCanvas().areaDown(TYPO3.jQuery(this).data("obj").getId())
        });
        TYPO3.jQuery("#" + this.getFormId() + "_undo").data("obj", this).click(function(a) {
            TYPO3.jQuery(this).data("obj").performUndo()
        });
        TYPO3.jQuery("#" + this.getFormId() + "_redo").data("obj", this).click(function(a) {
            TYPO3.jQuery(this).data("obj").performRedo()
        });
        this.applyBasicTypeActions();
        if (!this._moreOptionsVisible) {
            TYPO3.jQuery("#" + this.getFormId() + " > .moreOptions").hide()
        } else {
    ...
    updateStatesFromForm: function() {
        this.setLink(TYPO3.jQuery("<div/>").text(TYPO3.jQuery("#" + this.getFormId() + "_link").attr("value")).html());
        this.setLabel(TYPO3.jQuery("<div/>").text(TYPO3.jQuery("#" + this.getFormId() + "_label").attr("value")).html());
        var a = this;
        if (typeof this._attr != "object") {
            return
        }
        TYPO3.jQuery.each(this._attr, function(b, c) {
            a._attr[b] = TYPO3.jQuery("<div/>").text(TYPO3.jQuery("#" + a.getFormId() + "_" + b).attr("value")).html()
        })
    },
    getCommonFormUpdateFields: function() {
        ...
        if (typeof this._attr == "object") {
            var b = this;
            TYPO3.jQuery.each(this._attr, function(c, d) {
    ...
    applyAdditionalAreaActions: function() {
        ...
        TYPO3.jQuery("#" + this.getFormId() + "_color > .colorPicker").data("area", this).simpleColor({
            colors: this._colors
        }).click(function(b, c) {
    ...
    refreshExpandButtons: function() {
        TYPO3.jQuery("#" + this.getFormId() + " > .basicOptions > .exp > .expUpDown").hide();
        if (this.isMoreOptionsVisible()) {
            TYPO3.jQuery("#" + this.getFormId() + " > .basicOptions > .exp > .up").show()
        } else {
            TYPO3.jQuery("#" + this.getFormId() + " > .basicOptions > .exp > .down").show()
        }
    },
    ...
    changeUndoBtnStates: function() {
        TYPO3.jQuery("#" + this.getFormId() + "_undo").css("visibility", (this._undoStack.length ? "visible" : "hidden"));
        TYPO3.jQuery("#" + this.getFormId() + "_redo").css("visibility", (this._redoStack.length ? "visible" : "hidden"))
    }
});
var areaCircleClass = areaClass.extend({
    ...
    updateCoordsFromForm: function(a) {
        this.setX(parseInt(TYPO3.jQuery("#" + this.getFormId() + "_x").val()));
        this.setY(parseInt(TYPO3.jQuery("#" + this.getFormId() + "_y").val()));
        this.setRadius(parseInt(TYPO3.jQuery("#" + this.getFormId() + "_radius").val()));
        this.getCanvas().updateCanvas(this.getId())
    },
...
var areaPolyClass = areaClass.extend({
    ...
    applyBasicTypeActions: function() {
        TYPO3.jQuery("#" + this.getFormId() + "_add").data("obj", this).click(function(a) {
            TYPO3.jQuery(this).data("obj").insertNewCoordAfterPoint(-1)
        })
    },
    applyAdditionalTypeActions: function() {
        TYPO3.jQuery("#" + this.getFormId() + "_more > .positionOptions > .addCoord").data("obj", this).click(function(a) {
            if (this.id.match(/^.*_after\d+$/)) {
                TYPO3.jQuery(this).data("obj").insertNewCoordAfterPoint(parseInt(this.id.replace(/^.*_after/g, "")))
            }
            if (this.id.match(/^.*_before\d+$/)) {
                TYPO3.jQuery(this).data("obj").insertNewCoordBeforePoint(parseInt(this.id.replace(/^.*_before/g, "")))
            }
        });
        TYPO3.jQuery("#" + this.getFormId() + "_more > .positionOptions > .rmCoord").data("obj", this).click(function(a) {
            TYPO3.jQuery(this).data("obj").removeCoord(parseInt(this.id.replace(/^.*_rm/g, "")))
        })
    },
    updateCoordsFromForm: function(b) {
        for (var a = 0; a < this._coords.length; a++) {
            this._coords[a].x = parseInt(TYPO3.jQuery("#" + this.getFormId() + "_x" + a).val());
            this._coords[a].y = parseInt(TYPO3.jQuery("#" + this.getFormId() + "_y" + a).val())
        }
        this.getCanvas().updateCanvas(this.getId())
    },
    ...
    borderWasHit: function(b, a, c) {
        this._coords.splice(b + 1, 0, {
            x: this.reverseScale(a),
            y: this.reverseScale(c)
        });
        this.getCanvas().updateCanvas(this.getId());
...
var areaRectClass = areaClass.extend({
    ...
    applyAdditionalTypeActions: function() {},
    updateCoordsFromForm: function(a) {
        this.setX(parseInt(TYPO3.jQuery("#" + this.getFormId() + "_x1").val()), parseInt(TYPO3.jQuery("#" + this.getFormId() + "_x2").val()));
        this.setY(parseInt(TYPO3.jQuery("#" + this.getFormId() + "_y1").val()), parseInt(TYPO3.jQuery("#" + this.getFormId() + "_y2").val()));
        this.getCanvas().updateCanvas(this.getId())
    },
    hitOnObjectEdge: function(d, c, b) {
        var a = -1;
